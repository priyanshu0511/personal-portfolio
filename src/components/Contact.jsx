...
//     <div name='contact' className='min-h-screen w-full bg-blue max-h-[130vh] px-32 mt-40'>
//     <div>
//         <div>
//             <div className='text-4xl text-yellow font-bold border-b-4 border-gray-400 inline'>Contact</div>
//           <p className='py-6 text-lg text-lightblue font-mono'>Submit the form below to get in contact with me:</p>
//         </div>
//         <motion.div 
//           initial={{ opacity: 0 }}
...
//             {error && name.length<=0?<label className='my-4 text-lightblue'>Name cannot be empty!</label>:""}
...
//             {error && email.length<=0?<label className='mb-4 text-lightblue'>Email cannot be empty!</label>:""}
//             <textarea name="message" onChange={e=>setMsg(e.target.value)} placeholder='Enter your message' rows="7" className='p-2 bg-transparent border-2 rounded-md text-white focus:outline-none'></textarea>
//             {error && msg.length<=0?<label className='mt-4 text-lightblue'>Message cannot be Empty!</label>:""}
